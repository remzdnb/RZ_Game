/// RemzDNB
///
///	RZ_CharacterMovementComponent.h
///
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#include "RZ_CharacterMovementComponent.generated.h"

UENUM(BlueprintType)
enum class ERZ_CharacterMovementMode : uint8
{
	IdleWalk,
	Run,
	Sprint
...
class RZ_CHARACTERPAWNPLUGIN_API URZ_CharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()

public:

	URZ_CharacterMovementComponent();
	...
	UFUNCTION()
	uint8 GetIsSprinting() const { return WantsToSprint; }
