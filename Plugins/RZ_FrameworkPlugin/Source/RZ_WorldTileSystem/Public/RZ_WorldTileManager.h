...
#include "RZ_WorldTileManager.generated.h"

class UArrowComponent;

UCLASS()
class ARZ_WorldTileManager : public AActor
{
	GENERATED_BODY()
	
public:	

	ARZ_WorldTileManager();
...
private:
	...
	UPROPERTY()
	TArray<ARZ_WorldTile*> PooledTiles;
	
	UPROPERTY()
	TArray<ARZ_WorldTile*> ActiveTiles;
